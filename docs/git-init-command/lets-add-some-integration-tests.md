...
* How to write [integration tests in Rust.](https://doc.rust-lang.org/rust-by-example/testing/integration\_testing.html)
...
Next test! If we have an empty base\_directory, `is_dot_git_empty` should happily return true. Because we don't .git
